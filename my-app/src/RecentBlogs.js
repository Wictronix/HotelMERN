  ...
  return (
    <div>
      <div className="stay ht4 ">
          <h1 className="text-center mt-0 ">Recent Blogs</h1>
        </div>
       ...
       <div className="row mt-5">
        ...
        <div class="card">
                    ...
                    <div class="card-body text-center ">
                     ...
                     <a style={{paddingLeft:"18px",fontSize:"20px",paddingRight:"18px",paddingTop:"8px",paddingBottom:"8px",borderRadius:"10px"}} href="./score.html" className="btn56">Read</a>
                    </div>
