...
<div className="stay">
  <h1 className="text-center mt-0"> Restaurant</h1>
</div>
...
<div className="stay">
  <h1 className="text-center mt-0"> EXPLORE</h1>
</div>
...
<div className="stay">
  <h1 className="text-center mt-0"> BLOGS</h1>
</div>
...
<div className="stay ">
  <h1 className="text-center mt-0"> DISCOVER</h1>
