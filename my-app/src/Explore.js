    ...
    <div>
     ...
     <Navbar className="hell p-0 m-0" bg="black"  fixed="top" expand="lg" variant="dark">
      ...
      <div className="outer_div22">
        <img src="https://img.freepik.com/premium-vector/people-eat-cafe-illustration-cartoon-friend-characters-group-eating-lunch-dinner-cafeteria-food-court-interior-meeting-business-friendly-conversation-white_213110-488.jpg?w=2000"/>

        <div className="content d-flex align-items-center">
          <div className="container text-center ">
            {/* <h1>Welcome to Paradise Inn </h1>
            <h2 className="text-center">CHENNAI</h2> */}
             <h3 style={{opacity:1,fontSize:60}}>Explore</h3>
      ...
      <div className="row ro1">
        ...
        <div className="stay">
          <h1 className="text-center mt-0"> WELCOME</h1>
        </div>
        ...
        <div className="stay">
          <h1 className="text-center mt-0">  Check In</h1>
        </div>
        ...
        <div className="stay">
          <h1 className="text-center mt-0"> Spirits Bar</h1>
        </div>
        ...
        <div className="stay">
          <h1 className="text-center mt-0"> Living Room</h1>
        </div>
        ...
        <div className="stay">
          <h1 className="text-center mt-0"> Living Kitchen</h1>
        </div>
        ...
        <div className="stay">
          <h1 className="text-center mt-0"> Working Spaces</h1>
        </div>
        ...
        <div className="stay">
          <h1 className="text-center mt-0"> Green Spaces</h1>
        </div>
